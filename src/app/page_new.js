        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Upload Sources</h3>
              <p className="text-gray-600 text-sm">PDFs, CSVs, text files, or paste content</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Receive intelligent, context-aware answers</p>
            </div>
          </div>
